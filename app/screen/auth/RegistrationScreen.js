      ...
      <ScrollView keyboardShouldPersistTaps='handled'>
        <View style={{ marginHorizontal: 30 }}>
          <View style={styles.inputWithLabel}>
            ...
            <TextInput style={styles.input} value={name} onChangeText={setName} placeholder="Write Your Name" onPress={console.log(name)} />
          </View>
          ...
          <View style={styles.inputWithLabel}>
            ...
            <TextInput style={styles.input} value={password_confirmation} onChangeText={setPassword_confirmation} placeholder="Write Your Confirm Password" secureTextEntry={true} onPress={console.log(password_confirmation)} />
          </View>
